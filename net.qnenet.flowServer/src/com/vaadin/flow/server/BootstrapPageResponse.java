...
public class BootstrapPageResponse {
	 ...
	 *
	 * @param request     the Vaadin request for which the bootstrap page should be
	 *                    generated.
	 * @param session     the service session for which the bootstrap page should be
	 *                    generated.
	 * @param response    the Vaadin response that serves the bootstrap page.
	 * @param document    the DOM document making up the HTML page.
	 * @param uriResolver the uri resolver utility
	 *
	 * @param ui          the UI for the bootstrap.
	 */
	public BootstrapPageResponse(VaadinRequest request, VaadinSession session, VaadinResponse response,
			Document document, UI ui, VaadinUriResolver uriResolver) {
	...
	/**
	 * Sets a header value that will be added to the HTTP response. If the header
	...
	/**
	 * Properly formats a timestamp as a date in a header that will be included in
	 * the HTTP response. If the header had already been set, the new value
	...
	/**
	 * Gets the document node representing the root of the DOM hierarchy that will
	 * be used to generate the HTML page. Changes to the document will be reflected
	 * in the HTML.
	 *
	 ...
	 * This can be used to read request headers and other additional information.
	 *
