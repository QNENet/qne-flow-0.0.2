...
/**
 * A class to store the data about element name({@link Tag} annotation name
 * value) relation to all unique classes with corresponding annotation.
 *
 * @author Vaadin Ltd
 * @since 1.0.
 */
class CustomElements implements Serializable {
	...
	/**
	 * Maps each present custom element tag name to exactly one corresponding class.
	 * Throws exception if the operation is not possible.
	 *
	 ...
	 * @param newClass    class with corresponding annotation
	 */
